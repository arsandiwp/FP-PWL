   ...
   <div class="section">
      <div class="container">
         ...
         <div class="box">
               ...
               <tbody>
                  ...
                  <?php foreach ($_SESSION["keranjang"] as $product_id => $jumlah) : ?>
                     ...
                     <tr>
                        ...
                        <td>
                           <a href="hapuskeranjang.php?id=<?php echo $product_id ?>"><input type="submit" name="hapus" value="Hapus" class="btn"></a>
                        </td>
                     </tr>
                     <?php $nomor++; ?>
                  <?php endforeach ?>
            ...
            <a href="halaman.php"><input type="submit" name="lanjut_belanja" value="Lanjut Belanja" class="btn"></a>
            <!-- <a href="checkout.php"><input type="submit" name="checkout" value="Checkout" class="btn"></a> -->
            <a href="checkout.php"><input type="submit" name="checkout" value="Checkout" class="btn"></a>
         </div>
      </div>
   </div>
